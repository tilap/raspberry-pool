...
const Raspberry = exports.Raspberry = function () {
    function Raspberry(input) {
        return input != null && typeof input.id === 'string' && RaspberryData(input.data) && typeof input.registered === 'boolean' && (typeof input.online === 'boolean' || typeof input.online === 'string') && (typeof input.ip === 'string' || input.ip == null);
    }
