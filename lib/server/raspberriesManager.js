...
function changeConfig(id, config) {
    ...
    (0, _websocket.raspberriesBroadcast)(raspberry.online, 'changeConfig', newConfig);
    return newConfig;
}

function add(mac, _ref4) {
    let name = _ref4.name;
    let addOrReplace = _ref4.addOrReplace;
    let id = _ref4.id;
...
function sendAction(id, action) {
    ...
    (0, _websocket.raspberriesBroadcast)(raspberry.online, 'action', action);
    return raspberry;
}
