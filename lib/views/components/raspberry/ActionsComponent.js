...
let ActionsComponent = (_temp2 = _class = class ActionsComponent extends _react.Component {
    constructor() {
        var _temp;
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    availableActions.map(action => _react2.default.createElement(
                        ...
                        action.name,
                        _react2.default.createElement(_SpinnerComponent2.default, { active: !!raspberries.filter(raspberry => raspberry.actions && raspberry.actions[action.value] === 'sending' || action.isInProgress(raspberry)).length })
                    ))
                )
            )
        );
