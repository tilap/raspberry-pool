...
const actions = [{ name: 'Blink', value: 'blink', isVisible: r => true }, { name: 'Refresh', value: 'refresh', isVisible: r => r.screenState === 'on' }, { name: 'Screen on', value: 'screen-on', isVisible: r => r.screenState === 'off' }, { name: 'Screen off', value: 'screen-off', isVisible: r => r.screenState === 'on' }];
...
let RaspberryComponent = (_temp = _class = class RaspberryComponent extends _react.Component {
    ...
    render() {
        ...
        return _react2.default.createElement(
            ...
            !raspberry.online || !actions.length ? '' : _react2.default.createElement(
                'div',
                { className: 'actions' },
                _react2.default.createElement(
                    'div',
