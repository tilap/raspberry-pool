                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        availableActions.map(action => _react2.default.createElement(
                            ...
                            action.name,
                            _react2.default.createElement(_SpinnerComponent2.default, { active: raspberry.actions && raspberry.actions[action.value] === 'sending' || action.isInProgress(raspberry) })
                        ))
                    )
                )
            ),
